  ...
  return (
    <div className="flex min-h-[72vh] items-center justify-center px-4 py-12">
      <div className="luxury-panel w-full max-w-md rounded-[34px] p-7 sm:p-8">
        <p className="mb-2 text-center text-sm font-black text-tertiary">المغامر الفضي</p>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <label className="relative">
            ...
            <input required type="text" placeholder="البريد الإلكتروني أو اسم المستخدم" value={email} onChange={e => setEmail(e.target.value)} className="w-full rounded-2xl border border-white/10 bg-background/50 py-3 pl-4 pr-12 outline-none transition-colors focus:border-tertiary" />
          </label>
          <label className="relative">
